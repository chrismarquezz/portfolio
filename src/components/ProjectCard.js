...
export default function ProjectCard({ project }) {
  return (
    <motion.div
      ...
      className="w-full max-w-sm rounded-xl overflow-hidden shadow-lg bg-gray-50 dark:bg-slate-800 flex flex-col group transition-shadow duration-300 ease-in-out hover:shadow-2xl"
